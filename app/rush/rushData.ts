...
export const rushData: RushEvent[] = [
  ...
  },
  {
    name: "GATOR ROAST",
    description:
      "We bring in a freshly hunted Florida bayou alligator, coat it with our secret spice blend, and slow-cook it over an open fire for eight hours. The finished roast is served to brothers, alumni, and PNMs as we gather together, share stories, and get to know one another.",
    datetime: "2025-09-06T14:00:00",
  ...
  {
    name: "IFC BBQ",
    description: "BBQ catered by the IFC in Centennial Commons.",
    datetime: "2025-09-13T12:00:00",
    location: "Centenial Quad",
    image: "images/pongTrophy.JPG",
    open: true,
  },
  {
